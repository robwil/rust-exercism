...
#[test]
fn test_early_years() {
    assert_eq!(leap::is_leap_year(1), false, "1 should not be leap year");
    assert_eq!(leap::is_leap_year(4), true, "4 should be leap year");
    assert_eq!(
        leap::is_leap_year(100),
        false,
        "100 should not be leap year"
    );
    assert_eq!(leap::is_leap_year(400), true, "400 should be leap year");
    assert_eq!(
        leap::is_leap_year(900),
        false,
        "900 should not be leap year"
    );
}
